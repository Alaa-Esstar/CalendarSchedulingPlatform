            ...
            {data.eventType.length === 0 ? (
                ...
                <>
                    <div className="flex items-center justify-between px-2">
                        ...
                        <Button asChild><Link href={"/dashboard/new"}>Create new Event</Link></Button>
                    </div>
                        ...
                        {data.eventType.map((item) => (
                            <div key={item.id} className="overflow-hidden shadow rounded-lg border relative">
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuGroup>
                                                ...
                                                <DropdownMenuItem>
                                                    <Pen className="mr-2 soze-4" /> Edit
                                                </DropdownMenuItem>
                                            </DropdownMenuGroup>
                                            <DropdownMenuSeparator />
                                            <DropdownMenuItem>
                                ...
                                <div className="bg-muted px-5 py-3 justify-between items-center flex">
                                    <Switch className="dark:bg-muted-foreground dark:data-[state=checked]:bg-primary" />
